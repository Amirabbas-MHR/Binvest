...
class App:
    ...
    class Tab:
        ...
        def Quick_tab(self):
            ...
            table_df = crypto.get_dataframe(10, columns=["PRICE", "CHANGEPCTDAY"], replace_coin_name=True) #Quick and important data for first 10 coins
